...
Hyper-Advanced Demo: ./advanced-demo.html - A full-featured showcase with multiple image categories, all resolutions, and a polished UI.
Simple Widget Demo: ./demo.html - A minimal, clean example to get you started.
QUICK START
...
Click the "Upscale All Images" button and watch the magic happen!
HOW IT WORKS
The architecture is designed for maximum compatibility and ease of use.
...
Advanced Demo:
The advanced-demo.html file showcases a more complex implementation, including:

Selection of all available resolutions (256px to 8192px).
Selection of all four upscaling algorithms.
Multiple image categories in a tabbed interface.
A progress bar and status updates for each image.
Links to view the full-resolution upscaled images in a new tab.
AVAILABLE ALGORITHMS
The engine includes several unique upscaling algorithms, each with a distinct visual style:
...
A: This is a common browser security issue. Our demos solve this by:

Adding the crossorigin="anonymous" attribute to the <img> tag.
Using fetch() to convert the image into a Blob before processing.
Ensure you are following this pattern for any external images.
